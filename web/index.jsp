...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <h4>SITA es una nueva manera de llevar la administración de sus pacientes que le permitirá cambiar por completo su concepto sobre la asignación de citas, el seguimiento a pacientes y la gestion de los mismos.</h4><br>
      <p>Tanto si su consultorio es pequeño o si administra un gran hospital SITA se adaptara a sus necesidades y las de sus pacientes. Desde el registro inicial de sus pacientes podrán agendar sus citas el dia y la hora que mas les convengan, el sistema las mantendra organizadas. Deje de preocuparse por el control, SITA llevara la administración de sus pacientes, citas y consultas y, al permitir la interacción  de los pacientes se generara un ambiente de integración.</p>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-4">
      ...
      <h4>INTERACCIÓN</h4>
      <p>Acerquese a sus pacientes y mantenga un contacto permanente con ellos</p>
    </div>
    <div class="col-sm-4">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>ECO</h4>
      <p>Deshagase del papel y las agendas, ayudenos a salvar el planeta</p>
    </div>
    <div class="col-sm-4">
    ...
    <div class="col-sm-4">
      ...
      <p>Nuestro equipo estará siempre disponible para ayudarlo, trabajamos dia y noche para su beneficio</p>
    </div>
  </div>
</div>
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Este sistema es increible, nuestros pacientes lo adoran"<br><span style="font-style:normal;">Miguel Hernandez, Gastrointerologo, Hospital San Pedro</span></h4>
      </div>
      <div class="item">
        <h4>"Simplemente genial"<br><span style="font-style:normal;">Alberto Jaso, Administrador general, Clinica Lomas High</span></h4>
      </div>
      <div class="item">
        <h4>"No podría estar más satisfecho con este servicio<br><span style="font-style:normal;">Carlos Fuentes, Dentista, Clinica DentiPlus</span></h4>
      </div>
    </div>
...
<div id="pricing" class="container-fluid">
  <div class="text-center">
    <h2>Precios</h2>
    <h4>Elija el plan que más le convenga o contactenos para armar uno a su medida</h4>
  </div>
  <div class="row slideanim">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      <p>Pongase en contacto con nosotros y le responderemos en las proximas 24 horas.</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> México, DF</p>
      <p><span class="glyphicon glyphicon-phone"></span> +52 1515151515</p>
...
<div id="login" class="container-fluid">
    <h2 class="text-center">Ingrese con su cuenta</h2>
    <center>
    <s:form action="/Login">
    <div class="col-sm-7 slideanim">
      <div class="row">
        <div class="col-sm-6 form-group">
          <s:textfield placeHolder="ID" name="username" label="Username"/>
