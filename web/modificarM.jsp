  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <%
            ...
            if(3==3){
            rs2=manejador.executeQuery("SELECT * FROM medicos WHERE id_med='"+Id+"' ");
            out.println("<table class=\"table table-striped table-bordered table-responsive\">");
            out.println("<thead>");
            out.println("<tr>");
            out.println("<th>Nombre</th>");
            out.println("<th>Apellido</th>");
            out.println("<th>Calle y #</th>");
            ...
            while(rs2.next()){
                ...
                out.println("<tr>");
                out.println("<th>"+rs2.getString("medicos.nom_med")+"</th>");
                out.println("<th>"+rs2.getString("medicos.ap_med")+"</th>");
                out.println("<th>"+rs2.getString("medicos.calle_med")+"</th>");
                out.println("<th>"+rs2.getString("medicos.Col_med")+"</th>");
                out.println("<th>"+rs2.getString("medicos.Del_med")+"</th>");
                out.println("</tr>");
                ...
                out.println("<tr>");
                out.println("<th>"+rs2.getString("medicos.Cd_med")+"</th>");
                out.println("<th>"+rs2.getString("medicos.Ced_med")+"</th>");
                out.println("<th>"+rs2.getString("medicos.Ed_med")+"</th>");
